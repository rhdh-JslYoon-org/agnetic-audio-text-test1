...
3) Access the `workbench` named `agnetic-audio-text-test1-notebook`.
...
5) In the terminal, run `cd agnetic-audio-text-test1` to navigate to your sample app's directory.
